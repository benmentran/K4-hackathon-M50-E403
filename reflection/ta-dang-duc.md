...
Tôi không để AI tự quyết định số liệu hay bịa thêm bằng chứng — những chỗ chưa đủ dữ liệu thật (ví dụ chỉ có 2/5 quote nguyên văn, §3 chưa ai trong nhóm thật sự dùng thử NotebookLM/ChatGPT Study Mode) tôi giữ nguyên là việc còn thiếu (`[TODO]`) thay vì điền cho đủ, vì rubric của khoá nói rõ số liệu bị chỉnh sửa/che giấu sẽ không được tính điểm.
